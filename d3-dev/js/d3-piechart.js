function d3test(identifier) {
	...
	var pie = d3.layout.pie()
		.value(function(d) { return d.max }); // set object accessor for pie
	...
	arcs.append("path")
		.attr("fill", function(d, i) {
		        if (i%2==0) {return colors["warning"]} else {return colors["info"]}
		    })
	    .attr("d", innerArc());
	// vis.data(pie(sampleData))
	// var visenter = vis.enter()
	// 	.append("path")
	// 	.attr("d", innerArc().startAngle())
	// 	.
